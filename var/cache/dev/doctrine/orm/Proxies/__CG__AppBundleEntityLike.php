 ...
 */
class Like extends \AppBundle\Entity\Like implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Like' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Like' . "\0" . 'commentaires', '' . "\0" . 'AppBundle\\Entity\\Like' . "\0" . 'users'];
        }
