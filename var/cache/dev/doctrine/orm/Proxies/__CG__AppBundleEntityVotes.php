 ...
 */
class Votes extends \AppBundle\Entity\Votes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Votes' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Votes' . "\0" . 'refId', '' . "\0" . 'AppBundle\\Entity\\Votes' . "\0" . 'ref', '' . "\0" . 'AppBundle\\Entity\\Votes' . "\0" . 'vote', '' . "\0" . 'AppBundle\\Entity\\Votes' . "\0" . 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Votes $proxy) {
    ...
    public function setVote($vote)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVote', [$vote]);
